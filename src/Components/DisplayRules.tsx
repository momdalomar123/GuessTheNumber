...
<<<<<<< HEAD
        <div className={`absolute right-5  top-14 sm:top-14 md:top-16 w-50 md:w-60 mt-2 bg-zinc-500 rounded-md px-2.5 z-10 ${animationType} ${display}`}>
=======
        <div className={`absolute right-5 min-lg:bottom-25 max-sm:top-10 w-60 mt-2 bg-zinc-500 rounded-md px-2.5 z-10 ${animationType} ${display}`}>
